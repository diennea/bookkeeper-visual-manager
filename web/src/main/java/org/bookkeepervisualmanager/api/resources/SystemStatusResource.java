...
public class SystemStatusResource extends AbstractBookkeeperResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public ClusterWideConfiguration getClusterWideConfiguration() throws Exception {
        BookkeeperManager.RefreshCacheWorkerStatus refreshWorkerStatus = getBookkeeperManger().getRefreshWorkerStatus();
        BookkeeperManager.ClusterWideConfiguration clusterWideConfiguration = refreshWorkerStatus.getLastClusterWideConfiguration();
        return new ClusterWideConfiguration(clusterWideConfiguration.getAuditor(),
                clusterWideConfiguration.isAutorecoveryEnabled(),
                clusterWideConfiguration.getLostBookieRecoveryDelay(),
                clusterWideConfiguration.getLayoutFormatVersion(),
                clusterWideConfiguration.getLayoutManagerFactoryClass(),
                clusterWideConfiguration.getLayoutManagerVersion(),
                refreshWorkerStatus.getBookkkeeperClientConfiguration());
    }

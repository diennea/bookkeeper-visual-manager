...
#JAVA_HOME=
JAVA_OPTS="-XX:+UseG1GC -Duser.language=en -Xmx1g -Xms1g -Djava.net.preferIPv4Stack=true -XX:MaxDirectMemorySize=1g  -Djava.util.logging.config.file=conf/logging.properties"
